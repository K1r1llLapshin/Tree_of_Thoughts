START_PROMT ='''You are an expert analyst. Your task is to analyze the user's problem and propose {k} distinct, independent directions or initial steps to solve it. 
...
THOUGHT_PROMT ='''You are an expert analyst. Your task is to continue the reasoning chain to solve the problem.
...
Option 1: [Text of the first option]
Option 2: [Text of the second option]
...
Option {k}: [Text of the k-th option]'''


SUMMARY_PROMT ='''You are an expert in information synthesis. Your task is to provide a final, complete, and clear answer to the user's problem based on the successful reasoning chain.
