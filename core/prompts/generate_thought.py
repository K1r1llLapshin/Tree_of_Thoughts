START_PROMPT ='''You are an expert analyst. Your task is to analyze the user's problem and propose {k} distinct initial steps to solve it. 
...
SUMMARY_PROMPT ='''You are an expert in information synthesis. Your task is to provide a final, complete, and clear answer to the user's problem based on the 
...
Based on this logic, write a coherent final response. Do not mention the internal "thought process" or "steps above"—simply provide the high-quality final answer 
